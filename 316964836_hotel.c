...
#include<string.h>
 ...
 void ScreenWel();//welcome screen Function prototype
 void Login(); //login Funtion prototype
 void frame();//frame Funtion prototype
 void admin();//admin loged main menu
 void mm1();//main menu 1-option Funtion prototype
 void mm2();//main menu 2-option Funtion prototype
 void mm3();//main menu 3-option Funtion prototype
 void back();//Using back to main menu Funtion prototype
 
  int fr,bsr,bdr,bfr,btr;//global veriable used for adding frame size,No of user reserving rooms
    ...
    int main(){
	  	 ...
	  	 ScreenWel();//welcome screen funtion calling
	     Login();//loin funion called

         return 0;
    }
  
  
     void ScreenWel(){// welcome screen funtion body
     ...
     void Login(){//login fuction
     	
		  fr=3;
     	 
	     	 int id ;//local variable for user id
			 int pa;//local variable for user password
     	 
     	 
     	      frame();//calling frame funtion
	 ...
	 void mm2(){//Main menu option 2
	 	...
	 	int sr=10;//10 single rooms available 
